...
try {
    ...
    if (UserPermissions::hasPermission($user_type, 'visualizar_estatisticas_completas')) {
    ...
    } elseif (UserPermissions::hasPermission($user_type, 'visualizar_proprias_manutencoes')) {
    ...
    if (UserPermissions::hasPermission($user_type, 'visualizar_todas_manutencoes')) {
    ...
    if (UserPermissions::hasPermission($user_type, 'visualizar_equipamentos')) {
    ...
    $manutencoes_por_mes = [];
    if (UserPermissions::hasPermission($user_type, 'visualizar_relatorios')) {
        if ($user_type === 'admin') {
    ...
    <main class="main-content">
        ...
        <header class="top-header">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <?php if (UserPermissions::hasPermission($user_type, 'gerenciar_usuarios')): ?>
        ...
        <div class="content-area">
            ...
            <div class="quick-actions fade-in">
                <?php if (UserPermissions::hasPermission($user_type, 'criar_manutencoes')): ?>
                ...
                <?php if (UserPermissions::hasPermission($user_type, 'visualizar_equipamentos')): ?>
                ...
                <?php if (UserPermissions::hasPermission($user_type, 'visualizar_relatorios')): ?>
                    ...
                    <div class="card table-card fade-in">
                        <div class="card-header">
                            <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-3">
                                ...
                                <?php if (UserPermissions::hasPermission($user_type, 'criar_manutencoes')): ?>
                                <a href="manutencoes.php" class="btn btn-primary-custom btn-sm">
                        ...
                        <div class="card-body p-0">
                            <?php if (empty($recent_manutencoes)): ?>
                                <div class="text-center p-5 text-muted">
                                    ...
                                    <?php if (UserPermissions::hasPermission($user_type, 'criar_manutencoes')): ?>
                                    <a href="manutencoes.php" class="btn btn-primary-custom mt-2">
                                    ...
                                    <table class="table table-hover mb-0">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <?php if (UserPermissions::hasPermission($user_type, 'visualizar_todas_manutencoes')): ?>
                                                <th class="d-none d-lg-table-cell"><i class="bi bi-person me-1"></i>Técnico</th>
                                                <?php endif; ?>
            ...
            <!-- Charts Section -->
            <?php if (!empty($manutencoes_por_mes) && UserPermissions::hasPermission($user_type, 'visualizar_relatorios')): ?>
            <div class="row mt-4">
                <div class="col-12">
